...
public class CustomerBeans {
    ...
    public CustomerBeans(Integer customer_id, String customer_name, String customer_contact, String customer_address, String customer_inserted_date, int customer_active, double customer_dept) {
